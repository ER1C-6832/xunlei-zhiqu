...
# Pipeline keeps the proven wire2 semantics but removes transport-only fields
...
PIPELINE_OUTPUT_CONTRACT = {
    "top": "required: rt=type,n=title,o=overview; optional: s=selected[],a=alternatives[],x=excluded[],u=uncertainties[],r=recommendations[]",
...
- 最终 JSON 使用 output_contract 的 wire2 短键。rt、n、o 必须输出。不要输出 role：Runtime 按所在组确定性补齐（s=primary,a=alternative,x=excluded,u=unknown）。不要输出 evidence_refs；空 ta 省略。
