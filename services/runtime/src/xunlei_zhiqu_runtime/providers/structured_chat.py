...
class StructuredChatProvider(ModelProviderAdapter):
    """Provider-neutral structured chat transport used by Runtime model capabilities.

    Node A supplies its sanitized EvidencePack/profile and Node B supplies a small
    sanitized semantic document. ProviderApiAdapter owns supplier/model dialect
    differences; Runtime orchestration never handles supplier request details.
    """
    ...
    async def generate_structured(
        ...
        *,
        ...
        """Provider-neutral small JSON generation used by Node B."""
        user_content = json.dumps(
            document,
            ensure_ascii=False,
            separators=(",", ":"),
